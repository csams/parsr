...
Backslash = Char("\\")
String = Many1(Letter | Digit | Punctuation).map(make_string)
DoubleQuoteString = Many1(Letter | Digit | NonDoubleQuotePunctuation | EscapedDoubleQuote | Backslash)
SingleQuoteString = Many1(Letter | Digit | NonSingleQuotePunctuation | EscapedSingleQuote | Backslash)
